#Esse codigo é para definir administrar o usuario. Ou seja, definir o que é obrigatorio ou não
#"normalize" siginifica um padrão do Django para padronizar um email, por exemplo. O usuario tem um modelo/regra a seguir para digitar o email
